...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/21 21:30:42 by tle-monn          #+#    #+#             */
/*   Updated: 2024/02/26 09:42:31 by tle-monn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	set_target_b(t_stack_node *a, t_stack_node *b) //function that sets for the current `a` node, its target node from stack `a`
{
...
void	init_nodes_b(t_stack_node *a, t_stack_node *b) //function that prepares the nodes for pushing `b` to `a`
{
	current_index(a);
	current_index(b);
	set_target_b(a, b);
